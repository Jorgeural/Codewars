...
function helpJesse(array){
    ...
    for(i = 0; i < array.length; i++){
      ...
      if (array[i].note == undefined) {
          newArr.push( "Pour " + array[i].amount + " mL of " + array[i].solution + " into a " + array[i].instrument);
      } else {
          newArr.push( "Pour " + array[i].amount + " mL of " + array[i].solution + " into a " + array[i].instrument + " (" + array[i].note + ")");
      }
    }
